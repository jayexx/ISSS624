...
From the Geovisualisation of the 4 peak periods, it is noted that the number of trips during weekdays is higher than weekends/holidays; while within the same type of days, evening is higher than morning. Amongst the bus stops, the highest number of trips across the 4 peak periods is from the bus interchanges; while by region, the southwestern region of Singapore seems to have the least number of trips across the 4 peak periods.  
